...
import 'package:flutter_clean_arch/framework/services/raja_ongkir_service.dart';
import 'package:flutter_clean_arch/framework/loggers/interceptor_logger.dart';
...
class NetworkModule {
  static void inject(Injector injector) {
    ...
    injector.registerDependency<RajaOngkirService>(
        () => RajaOngkirServiceImpl(injector.get()));
  }
}
