...
namespace Demo_BSI_Cache.Controllers
{
    ...
    public class PublishersController : ControllerBase
    {
        ...
        {
            var cacheKey = "GetPublishers";
            if (!memoryCache.TryGetValue(cacheKey, out List<Publisher> publisherList))
			{
                publisherList = await _context.Publishers.ToListAsync();
                var cacheExpiryOptions = new MemoryCacheEntryOptions
                {
                    AbsoluteExpiration = DateTime.Now.AddMinutes(5),
                    SlidingExpiration = TimeSpan.FromMinutes(1)
                };
                memoryCache.Set(cacheKey, publisherList, cacheExpiryOptions);
			}
